...
export default function Hero() {
    return (
        <section className="px-6 py-20 md:py-32 max-w-7xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-700 max-w-3xl leading-relaxed mb-12">
            ...
            <div className="flex gap-4">
                <Link
                    href="#projects"
                    className="px-6 py-3 bg-gray-100 hover:bg-gray-200 text-black rounded-md text-lg transition-colors inline-block"
                >
                    View My Work
                </Link>
            </div>
